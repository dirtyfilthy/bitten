...
public class Script {
    ...
    public byte[] getPubKeyHash() throws ScriptException {
    	...
    	// handle public key sends
    	
        if (chunks.size() == 2 && (0xFF & chunks.get(1)[0]) == OP_CHECKSIG){
        	System.out.println("public key: "+HexBin.encode(chunks.get(0)));
        	return Utils.sha256hash160(chunks.get(0));
        }
